...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          <div className="footer-reveal space-y-6">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
              ...
              <div>
                ...
                <span style={{ color: GOLD + "99", fontFamily: "'Montserrat', sans-serif", fontSize: "0.58rem", letterSpacing: "0.2em", textTransform: "uppercase" }}>{company.tagline}</span>
              </div>
            </div>

            <p style={{ color: SILVER + "99", fontSize: "0.8rem", lineHeight: 1.8, maxWidth: 360 }}>{company.description}</p>

            <SocialLinks />

            {/* Newsletter */}
            <div>
              <h4 style={{ fontSize: "0.62rem", fontFamily: "'Montserrat', sans-serif", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: GOLD + "88", marginBottom: "0.6rem" }}>
              ...
              {quickLinks.map((link: any) => {
                ...
                return (
                  <a
                    key={link.label}
                    href={link.href}
                    style={{ fontSize: "0.65rem", color: SILVER + "77", display: "flex", alignItems: "center", gap: "0.3rem", textDecoration: "none", transition: "color 0.2s", fontFamily: "'Montserrat', sans-serif" }}
                    onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = GOLD)}
                    onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = `${SILVER}77`)}
                  >
                    <LinkIcon /> {link.label}
                  </a>
                );
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-8 border-t border-border/10 text-[11px] text-muted-foreground/50 font-medium font-body text-center md:text-left">
          ...
          <div className="flex items-center gap-6 flex-wrap justify-center">
            {bottom.links.map((link: any) => (
              <a
                key={link.label}
                href={link.href}
                style={{ color: SILVER + "55", textDecoration: "none", transition: "color 0.2s" }}
                onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = GOLD)}
                onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = `${SILVER}55`)}
              >
                {link.label}
              </a>
            ))}
          ...
          <a
            ...
            style={{ color: SILVER + "33", textDecoration: "none", transition: "color 0.2s", fontFamily: "'Montserrat', sans-serif" }}
            onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = GOLD)}
            onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = `${SILVER}33`)}
          >
            {bottom.tagline}
          </a>
        </div>
      ...
      {/* ── Subtle bottom glow ── */}
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, background: `linear-gradient(to top, ${GOLD}06, transparent)`, pointerEvents: "none" }} />
    </footer>
  );
};
