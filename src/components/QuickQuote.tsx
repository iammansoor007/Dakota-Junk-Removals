...
const QuickQuote = () => {
    ...
    const projectTypes = [
        ...
        { value: 'shed-removal', label: 'Shed / Structure Removal' },
        { value: 'moving', label: 'Moving Assistance' },
        { value: 'demolition', label: 'Light Demolition' },
        { value: 'construction', label: 'Construction Cleanup' },
                                                    ...
                                                    >
                                                        <div>
                                                            ...
                                                            <textarea
                                                                ...
                                                                placeholder="Tell us what you need removed or cleaned out — we'll see if we can help!"
                                                            />
                                                        </div>
                                                    </motion.div>
                                                )}
